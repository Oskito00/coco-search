...
class DevelopmentConfig(Config):
    ...
    #Stripe
    STRIPE_PRICE_INDIVIDUAL_DEV = os.getenv('STRIPE_PRICE_INDIVIDUAL_DEV')
    STRIPE_PRICE_BUSINESS_DEV = os.getenv('STRIPE_PRICE_BUSINESS_DEV')
    STRIPE_PRICE_PRO_DEV = os.getenv('STRIPE_PRICE_PRO_DEV')
    STRIPE_SECRET_KEY_DEV = os.getenv('STRIPE_SECRET_KEY_DEV')
    STRIPE_PUBLISHABLE_KEY_DEV = os.getenv('STRIPE_PUBLISHABLE_KEY_DEV')
    STRIPE_WEBHOOK_SECRET_DEV = os.getenv('STRIPE_WEBHOOK_SECRET_DEV')
