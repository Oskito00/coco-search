...
Revision ID: 79e5d4e6caa5
Revises: 
Create Date: 2025-04-13 16:33:01.244121
...
def upgrade():
    ...
    op.execute("CREATE SEQUENCE keywords_keyword_id_seq START 1")

    op.alter_column('users', 'requested_change',
               existing_type=sa.JSONB(),
               server_default=None,
               existing_nullable=True)
    op.alter_column('users', 'pending_tier',
               existing_type=sa.JSONB(),
               server_default=None,
               existing_nullable=True)
